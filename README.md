...
build from source. First you need to clone the repository on your local
machine. This can be done by the following command:
...
- [x] Configure plugin to integrate as embeddable webapp
...
- [ ] Implement a ownvessel update mechanic from the plugin configuration menu
enable generic movement patterns: straight line, circle, etc.
